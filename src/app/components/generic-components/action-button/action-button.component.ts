...
export class ActionButtonComponent implements OnInit, OnChanges {
  ...
  ngOnChanges() {
    ...
    if (this.activePage === 'inbox') {
      this.actions.map((action, index) => {
        if (action === 'Finish') {
          ...
          this.tieredItems.push({
            label: 'Reply',
            icon: 'ui-icon-reply', command: (event) => {
          ...
          this.tieredItems.push({
            label: 'Reply-All',
            icon: 'ui-icon-reply-all', command: (event) => {
          ...
          this.tieredItems.push({
            label: 'Forward',
            icon: 'ui-icon-forward', command: (event) => {
          ...
          this.tieredItems.push({
            label: 'Flag',
            icon: 'ui-icon-flag', command: (event) => {
    ...
    if (this.activePage === 'archive') {
      this.tieredItems.push({
        label: 'Un-Archive',
        icon: 'ui-icon-unarchive', command: (event) => {
    ...
    if (this.activePage !== 'draft') {
      if (this.hasFilterRes) {
        this.tieredItems.push({
          label: 'Reset',
          icon: 'ui-icon-autorenew', command: (event) => {
            if (this.activePage === 'archive') {
