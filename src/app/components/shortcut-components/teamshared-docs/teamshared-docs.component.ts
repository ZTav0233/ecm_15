...
export class TeamsharedDocsComponent implements OnInit {
  ...
  constructor(private breadcrumbService: BreadcrumbService, private ds: DocumentService, private us: UserService, private coreService: CoreService,private toastr:ToastrService,
