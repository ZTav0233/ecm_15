...
export class DocumentService {
  ...
  addToFavorites(empno, id):any{
    const url = `${global.base_url}DocumentService/addToFavorites?empno=${empno}&id=${id}&sysdatetime=${this.coreService.getSysTimeStamp()}`;
    return this.http.get(url,{responseType:'text'});
  }

  addToFavoritesMulti(postdata: any):any{
    if(postdata.empNo){
      postdata.empNo=postdata.empNo;
    }
  ...
  getTeamDocuments(empno):any{
    const url = `${global.base_url}DocumentService/getTeamDocuments?empno=${empno}&sysdatetime=${this.coreService.getSysTimeStamp()}`;
    return this.http.get(url);
  }
  ...
  removeFromFavorites(empno, id):any{
    const url = `${global.base_url}DocumentService/removeFromFavorites?empno=${empno}&id=${id}&sysdatetime=${this.coreService.getSysTimeStamp()}`;
    return this.http.get(url,{responseType:'text'});
  }

  getFavourites(empno):any{
    const url = `${global.base_url}DocumentService/getFavorites?empno=${empno}&sysdatetime=${this.coreService.getSysTimeStamp()}`;
    return this.http.get(url);
  }

  getRecent(empno):any{
    const url = `${global.base_url}DocumentService/getRecent?empno=${empno}&sysdatetime=${this.coreService.getSysTimeStamp()}`;
    return this.http.get(url);
  }
  ...
  getCart(id):any{
    const url = `${global.base_url}DocumentService/getCart?empno=${id}&cfid=&sysdatetime=${this.coreService.getSysTimeStamp()}`;
    return this.http.get(url);
  }
  getEnclosureCart(id):any{
    //Abhishek 13.12.2022 - removed cfid value
    const url = `${global.base_url}DocumentService/getEnclosure?empno=${id}&cfid=&sysdatetime=${this.coreService.getSysTimeStamp()}`;
    return this.http.get(url);
  }
  ...
  addToCart(empNo, id):any{
    const url = `${global.base_url}DocumentService/addToCart?empno=${empNo}&id=${id}&sysdatetime=${this.coreService.getSysTimeStamp()}`;
    return this.http.get(url,{responseType:'text'});
  }
  ...
  removeFromCart(empNo: any, id: any):any{
    const url = `${global.base_url}DocumentService/removeFromCart?empno=${empNo}&id=${id}&sysdatetime=${this.coreService.getSysTimeStamp()}`;
    return this.http.get(url,{responseType:'text'});
  }
  removeFromEnclosure(empNo: any, id: any):any{
    const url = `${global.base_url}DocumentService/removeFromEnclosure?empno=${empNo}&id=${id}&sysdatetime=${this.coreService.getSysTimeStamp()}`;
    return this.http.get(url,{responseType:'text'});
  }
  ...
  getDocumentInfo(docid: any,isprop:any):any
  {
    ...
    const url = `${global.base_url}DocumentService/getDocumentInfo?id=${docid}&empno=${user.EmpNo}&isprops=${isprop}&sysdatetime=${this.coreService.getSysTimeStamp()}`;
    return this.http.get(url);
  }
  ...
  getDocumentDetails(id,empNo):any{
    const url = `${global.base_url}DocumentService/getDocumentDetails?id=${id}&empno=${empNo}&sysdatetime=${this.coreService.getSysTimeStamp()}`;
    return this.http.get(url);
  }
  ...
  getDocumentWorkItemDetails
  //  updateSign(witmid: any,status: any):any{
  //   const url = `${global.base_url}updateSign?witemid=${witmid}&existStatus=${status}&sysdatetime=${this.coreService.getSysTimeStamp()}`;
  //   return this.http.get(url);
  // }
